  ...
  <div>
    ...
    <div class="container">
      ...
      <el-table :data="tableData.content" border class="table" header-cell-class-name="table-header">
        ...
        <el-table-column prop="startedAt" label="创建时间" width='150px'></el-table-column>
        ...
        <el-table-column prop="subject" label="订单名"></el-table-column>
        ...
        <el-table-column prop="completedAt" label="完成时间" width='150px'></el-table-column>
        <el-table-column prop="chanTradeNo" label="通道id"></el-table-column>
      </el-table>
...
export default {
  ...
  methods: {
    list(page) {
      ...
      service.get(api.chargeBase + "?start=" + start + "&end=" + end + "&page=" + page
