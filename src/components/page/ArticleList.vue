    ...
    <div>
        ...
        <div class='container'>
            ...
            <el-table :data='tableData.content' border class='table' ref='multipleTable'
                ...
                <el-table-column label='系统删除'>
                    <template slot-scope='scope'>
                        <a v-if='!scope.row.del'>否</a>
                        <a v-if='scope.row.del' style='color: red'>是</a>
                    </template>
                </el-table-column>
                <el-table-column label='作者删除'>
                    <template slot-scope='scope'>
                        <a v-if='!scope.row.authorDel'>否</a>
                        <a v-if='scope.row.authorDel' style='color: red'>是</a>
                    </template>
                </el-table-column>
                <el-table-column label='操作'>
                    <template slot-scope='scope'>
                        <el-button type='primary' @click='gotoInfo(scope.row.id)'>查看详情</el-button>
                        <el-button type='primary' @click='gotoSystemInfo(scope.row.id)'>
                            编辑
                        </el-button>
                    </template>
                </el-table-column>
...
export default {
    ...
    methods: {
        ...
        list(page) {
            ...
            service.get(api.articleBase + '?start=' + start + '&end=' + end + '&page=' + page
                + '&size=' + this.query.size + '&del=' + this.search.del +
